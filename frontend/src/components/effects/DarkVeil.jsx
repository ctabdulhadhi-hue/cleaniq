...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      const renderW = Math.max(1, Math.floor(w * resolutionScale));
      const renderH = Math.max(1, Math.floor(h * resolutionScale));
      ...
      const actualW = gl.canvas.width || renderW;
      const actualH = gl.canvas.height || renderH;
    ...
    // Call resize immediately and on next animation frame / layout settlement
    resize();
